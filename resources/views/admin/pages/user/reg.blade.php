...
<div class="user">
    <header class="user__header">
        ...
        <h1 class="user__title">SIGN UP For POS</h1>
        <style>
            $font-family:   "Roboto";
            $font-size:     14px;
...
@keyframes move {
    ...
    <form class="form" action="{{route('admin.registration.store')}}" method='POST'>
      ...
      <div class="form__group">
        ...
        <div class="form__group">
            <input type="number" name="phone" placeholder="Enter Phone" class="form__input" />
        </div>
   ...
   <p>Have an Account? <a href="{{route('admin.login')}}"> Log In</a></p>
</div>
